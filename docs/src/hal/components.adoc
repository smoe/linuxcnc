...
=== Core LinuxCNC components[[sec:Realtime-Components-coeur]]
...
=== Arithmetic and float-components[[sec:Realtime-Components-flottant]]
...
From French: Utiliser le composant _encoder_ avec _... counter-mode = TRUE_.
...
=== Hardware Drivers[[sec:Realtime-Components-pilotes]]
...
=== Kinematics[[sec:Realtime-Components-cinematiques]]
