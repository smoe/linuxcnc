...
| Debian Bookworm| amd64 & armhf | preempt-rt | linuxcnc-uspace | machine control & simulation
...
. Make sure you have aonnection (preferably wired) to the internet
...
----
. Reboot into the PREEMPT_RT kernel log in with root and the password you set. Type:
