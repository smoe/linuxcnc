...
[[cha:Apercu-machine-CNC]](((Aercu Machine-CNC)))
...
=== Point contrôlé
[[sec:Point-controle]] (((point contrôlé)))
...
[[sec:Modes-de-controle-trajectoires]](((Modes de contrôle de trajectoire)))
...
=== Bouton d'effacement de bloc[[sub:block-delete-switch]]
...
=== Bouton d'arrêt optionnel du programme[[sub:optional-program-stop]]
